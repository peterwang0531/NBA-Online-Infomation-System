...
$query = 'Select Rank, playerName, threes From ThreePointLeaders';
  ...
  <head>
	...
	<ul>
	   ...
	   <li><a href="./DataWareHouse.php">Data WareHouse</a></li>
		...
		<h1>All time Three Pointer Leaders</h1>

<form action="addThreeLeaders.php" method="POST">
    <div>
      <input type="submit" value="ADD" style="float: right;width:125px;" >
    </div>
  </form>
...
while ($tuple = mysqli_fetch_row($result)) {
   print '<form action = "deleteThrees.php" method = "POST">';
   print '<tr>';
   print '<td>';
   print '<input type="submit" value="DELETE"/>';
   print '<input type="hidden" name="rank" ' . ' value="' . $tuple[0] . '"/>';
   print '<input type="hidden" name="playerName" ' . ' value="' . $tuple[1] . '"/>';
   print '</td>';
   print "<td>$tuple[0]</td>";
   print "<td>$tuple[1]</td>";
   print "<td>$tuple[2]</td>";
